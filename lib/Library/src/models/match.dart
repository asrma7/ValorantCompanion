...
class Match implements ISerializable<Match> {
  ...
  factory Match.fromMap(Map<String, dynamic> json) => Match(
        matchInfo: json["matchInfo"] != null
            ? MatchInfo.fromMap(json["matchInfo"])
            : null,
        players: json["players"] != null
            ? List<Player>.from(json["players"].map((x) => Player.fromMap(x)))
            : [],
        teams: json["teams"] != null
            ? List<Team>.from(json["teams"].map((x) => Team.fromMap(x)))
            : [],
        roundResults: json["roundResults"] != null
            ? List<RoundResultElement>.from(
                json["roundResults"].map((x) => RoundResultElement.fromMap(x)))
            : [],
        kills: json["kills"] != null
            ? List<Kill>.from(json["kills"].map((x) => Kill.fromMap(x)))
            : [],
      );
...
class Kill {
  ...
  factory Kill.fromMap(Map<String, dynamic> json) => Kill(
        ...
        killer: json["killer"],
        victim: json["victim"],
        victimLocation: json["victimLocation"] != null
            ? Location.fromMap(json["victimLocation"])
            : null,
        assistants: json["assistants"] == null
            ? []
            : List<String>.from(json["assistants"].map((x) => x)),
        playerLocations: json["playerLocations"] == null
            ? []
            : List<PlayerLocation>.from(
                json["playerLocations"].map((x) => PlayerLocation.fromMap(x))),
        finishingDamage: json["finishingDamage"] == null
            ? null
            : FinishingDamage.fromMap(json["finishingDamage"]),
      );
  ...
  Map<String, dynamic> toMap() => {
        ...
        "playerLocations":
            List<dynamic>.from(playerLocations.map((x) => x.toMap())),
...
class FinishingDamage {
  ...
  factory FinishingDamage.fromJson(String str) =>
      FinishingDamage.fromMap(json.decode(str));
...
class PlayerLocation {
  ...
  factory PlayerLocation.fromJson(String str) =>
      PlayerLocation.fromMap(json.decode(str));
  ...
  factory PlayerLocation.fromMap(Map<String, dynamic> json) => PlayerLocation(
        ...
        viewRadians:
            json["viewRadians"] == null ? 0 : json["viewRadians"].toDouble(),
...
class Player {
  ...
  factory Player.fromMap(Map<String, dynamic> json) => Player(
        ...
        platformInfo: json["platformInfo"] == null
            ? null
            : PlatformInfo.fromMap(json["platformInfo"]),
        teamId: json["teamId"],
        partyId: json["partyId"],
        characterId: json["characterId"],
        stats: json["stats"] == null ? null : Stats.fromMap(json["stats"]),
        roundDamage: json["roundDamage"] == null
            ? []
            : List<RoundDamage>.from(
                json["roundDamage"].map((x) => RoundDamage.fromMap(x))),
        ...
        newPlayerExperienceDetails: json["newPlayerExperienceDetails"] == null
            ? null
            : NewPlayerExperienceDetails.fromMap(
...
class NewPlayerExperienceDetails {
  ...
  factory NewPlayerExperienceDetails.fromJson(String str) =>
      NewPlayerExperienceDetails.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory NewPlayerExperienceDetails.fromMap(Map<String, dynamic> json) =>
      NewPlayerExperienceDetails(
        basicMovement: json["basicMovement"] == null
            ? null
            : BasicGunSkillClass.fromMap(json["basicMovement"]),
        basicGunSkill: json["basicGunSkill"] == null
            ? null
            : BasicGunSkillClass.fromMap(json["basicGunSkill"]),
        adaptiveBots: json["adaptiveBots"] == null
            ? null
            : AdaptiveBots.fromMap(json["adaptiveBots"]),
        ability: json["ability"] == null
            ? null
            : BasicGunSkillClass.fromMap(json["ability"]),
        bombPlant: json["bombPlant"] == null
            ? null
            : BasicGunSkillClass.fromMap(json["bombPlant"]),
        defendBombSite: json["defendBombSite"] == null
            ? null
            : DefendBombSite.fromMap(json["defendBombSite"]),
        settingStatus: json["settingStatus"] == null
            ? null
            : SettingStatus.fromMap(json["settingStatus"]),
      );
...
class BasicGunSkillClass {
  ...
  factory BasicGunSkillClass.fromJson(String str) =>
      BasicGunSkillClass.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory BasicGunSkillClass.fromMap(Map<String, dynamic> json) =>
      BasicGunSkillClass(
...
class AdaptiveBots {
  ...
  factory AdaptiveBots.fromJson(String str) =>
      AdaptiveBots.fromMap(json.decode(str));
  ...
  factory AdaptiveBots.fromMap(Map<String, dynamic> json) => AdaptiveBots(
        ...
        adaptiveBotAverageDurationMillisAllAttempts:
            json["adaptiveBotAverageDurationMillisAllAttempts"] ?? 0,
        adaptiveBotAverageDurationMillisFirstAttempt:
            json["adaptiveBotAverageDurationMillisFirstAttempt"] ?? 0,
...
class DefendBombSite {
  ...
  factory DefendBombSite.fromJson(String str) =>
      DefendBombSite.fromMap(json.decode(str));
...
class SettingStatus {
  ...
  factory SettingStatus.fromJson(String str) =>
      SettingStatus.fromMap(json.decode(str));
...
class PlatformInfo {
  ...
  factory PlatformInfo.fromJson(String str) =>
      PlatformInfo.fromMap(json.decode(str));
...
class RoundDamage {
  ...
  factory RoundDamage.fromJson(String str) =>
      RoundDamage.fromMap(json.decode(str));
...
class Stats {
  ...
  factory Stats.fromMap(Map<String, dynamic> json) => Stats(
        ...
        abilityCasts: json["abilityCasts"] == null
            ? null
            : AbilityCasts.fromMap(json["abilityCasts"]),
      );
...
class AbilityCasts {
  ...
  factory AbilityCasts.fromJson(String str) =>
      AbilityCasts.fromMap(json.decode(str));
...
class RoundResultElement {
  ...
  factory RoundResultElement.fromJson(String str) =>
      RoundResultElement.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory RoundResultElement.fromMap(Map<String, dynamic> json) =>
      RoundResultElement(
        ...
        plantPlayerLocations: json["plantPlayerLocations"] == null
            ? []
            : List<PlayerLocation>.from(json["plantPlayerLocations"]
                .map((x) => PlayerLocation.fromMap(x))),
        plantLocation: json["plantLocation"] == null
            ? null
            : Location.fromMap(json["plantLocation"]),
        plantSite: json["plantSite"],
        defuseRoundTime: json["defuseRoundTime"] ?? 0,
        defusePlayerLocations: json["defusePlayerLocations"] == null
            ? []
            : List<PlayerLocation>.from(json["defusePlayerLocations"]
                .map((x) => PlayerLocation.fromMap(x))),
        defuseLocation: json["defuseLocation"] == null
            ? null
            : Location.fromMap(json["defuseLocation"]),
        playerStats: json["playerStats"] == null
            ? []
            : List<PlayerStat>.from(
                json["playerStats"].map((x) => PlayerStat.fromMap(x))),
        roundResultCode: json["roundResultCode"],
        playerEconomies: json["playerEconomies"] == null
            ? []
            : List<Economy>.from(
                json["playerEconomies"].map((x) => Economy.fromMap(x))),
        playerScores: json["playerScores"] == null
            ? []
            : List<PlayerScore>.from(
                json["playerScores"].map((x) => PlayerScore.fromMap(x))),
  ...
  Map<String, dynamic> toMap() => {
        ...
        "plantPlayerLocations":
            List<dynamic>.from(plantPlayerLocations.map((x) => x.toMap())),
        "plantLocation": plantLocation?.toMap(),
        "plantSite": plantSite,
        "defuseRoundTime": defuseRoundTime,
        "defusePlayerLocations":
            List<dynamic>.from(defusePlayerLocations.map((x) => x.toMap())),
        ...
        "playerEconomies":
            List<dynamic>.from(playerEconomies.map((x) => x.toMap())),
...
class PlayerScore {
  ...
  factory PlayerScore.fromJson(String str) =>
      PlayerScore.fromMap(json.decode(str));
...
class PlayerStat {
  ...
  factory PlayerStat.fromJson(String str) =>
      PlayerStat.fromMap(json.decode(str));
  ...
  factory PlayerStat.fromMap(Map<String, dynamic> json) => PlayerStat(
        ...
        damage: json["damage"] == null
            ? []
            : List<Damage>.from(json["damage"].map((x) => Damage.fromMap(x))),
        score: json["score"],
        economy:
            json["economy"] == null ? null : Economy.fromMap(json["economy"]),
        ability: json["ability"] == null
            ? null
            : PlayerStatAbility.fromMap(json["ability"]),
        wasAfk: json["wasAfk"],
...
class PlayerStatAbility {
  ...
  factory PlayerStatAbility.fromJson(String str) =>
      PlayerStatAbility.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory PlayerStatAbility.fromMap(Map<String, dynamic> json) =>
      PlayerStatAbility(
