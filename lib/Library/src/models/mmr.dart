...
class MMR implements ISerializable<MMR> {
  ...
  factory MMR.fromMap(Map<String, dynamic> json) => MMR(
        ...
        newPlayerExperienceFinished:
            json["NewPlayerExperienceFinished"] ?? false,
        queueSkills: json["QueueSkills"] == null
            ? null
            : QueueSkills.fromMap(json["QueueSkills"]),
        latestCompetitiveUpdate: json["LatestCompetitiveUpdate"] == null
            ? null
            : LatestCompetitiveUpdate.fromMap(json["LatestCompetitiveUpdate"]),
      );
  ...
  Map<String, dynamic> toMap() => {
        ...
        "LatestCompetitiveUpdate": latestCompetitiveUpdate == null
            ? null
            : latestCompetitiveUpdate!.toMap(),
      };
...
class LatestCompetitiveUpdate {
  ...
  factory LatestCompetitiveUpdate.fromJson(String str) =>
      LatestCompetitiveUpdate.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory LatestCompetitiveUpdate.fromMap(Map<String, dynamic> json) =>
      LatestCompetitiveUpdate(
...
class QueueSkills {
  ...
  factory QueueSkills.fromJson(String str) =>
      QueueSkills.fromMap(json.decode(str));
  ...
  factory QueueSkills.fromMap(Map<String, dynamic> json) => QueueSkills(
        competitive: json["competitive"] == null
            ? null
            : Competitive.fromMap(json["competitive"]),
        custom:
            json["custom"] == null ? null : Competitive.fromMap(json["custom"]),
        seeding: json["seeding"] == null
            ? null
            : Competitive.fromMap(json["seeding"]),
        spikerush: json["spikerush"] == null
            ? null
            : Competitive.fromMap(json["spikerush"]),
        unrated: json["unrated"] == null
            ? null
            : Competitive.fromMap(json["unrated"]),
      );
...
class Competitive {
  ...
  factory Competitive.fromJson(String str) =>
      Competitive.fromMap(json.decode(str));
